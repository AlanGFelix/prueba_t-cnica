<div class="d-flex flex-column align-items-center w-75">
    ...
    <div class="d-flex justify-content-center w-75 border border-1">
        <form method="POST" action="store" class="d-flex flex-column gap-3 w-50">
            <div class="d-flex justify-content-between mx-5 mt-5">
                ...
                <select id="parent" name="parent" class="form-control" style="width: 200px;">
                    <option selected value="">Elige el Menú padre</option>
                    <?php
                        $menus = $data['menus'];
            ...
            <div class="d-flex justify-content-between mx-5">
                ...
                <input id="name" name="name" class="form-control" style="width: 200px;"/>
            </div>
            <div class="d-flex justify-content-between mx-5">
                <label for="description">Descripción</label>
                <textarea id="description" name="description" class="form-control" style="width: 200px;"></textarea>
            </div>
